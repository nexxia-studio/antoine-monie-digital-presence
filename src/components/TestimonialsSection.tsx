      ...
      <div className="max-w-6xl mx-auto section-fade-in">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {testimonials.map((t_item, i) => (
            <div
              key={i}
              className="relative rounded-xl border border-border bg-card p-6 pl-8 border-l-[3px] border-l-primary"
            >
              {/* Decorative quote */}
              ...
              <p
                className={`text-sm text-muted-foreground leading-relaxed mt-6 mb-4 ${
